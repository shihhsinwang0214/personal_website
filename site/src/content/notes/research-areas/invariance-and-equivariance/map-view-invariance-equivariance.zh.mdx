...
輸入變了，不代表所有答案都應該變；但也不代表所有答案都應該保持一樣。所以真正要判斷的是：
...
<iframe loading="lazy" src="/personal_website/notes/research_areas/invariance-and-equivariance/map-output-types.html" class="demo-frame" title="地圖視角與輸出型態互動 demo" style="height: 720px; width: 100%; border: none;"></iframe>

> **invariance 保留答案；equivariance 保留輸入與輸出之間的幾何關係。**
