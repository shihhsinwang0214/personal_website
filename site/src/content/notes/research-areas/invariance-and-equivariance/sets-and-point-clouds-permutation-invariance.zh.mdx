...
<iframe src="/personal_website/notes/research_areas/invariance-and-equivariance/set-permutation.html" class="demo-frame" title="集合排列不變性互動 demo" style="height: 720px; width: 100%; border: none;"></iframe>
